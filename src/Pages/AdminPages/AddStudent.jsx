...
import { SearchOutlined, UserOutlined, PlusCircleTwoTone } from '@ant-design/icons';
...
const AllStudentsPage = () => {
    ...
    const showAddModel = (student) => {
        setstudentAddKey(student);
        setIsModalVisible(true);
    };

    const handleAdd = () => {
        setStudents(students.filter(student => student.key !== studentAddKey.key));
        message.success(`Student ${studentAddKey.name} add successfully`);
        ...
        <>
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                    <h1 className="text-2xl font-bold text-gray-800 mb-4 md:mb-0">All waiting Students</h1>
                ...
                >
                    {studentAddKey && (
                        <div className="flex flex-col items-center py-4">
                            <Avatar
                                src={studentAddKey.avatar}
                                size={64}
                                icon={<UserOutlined />}
                                className="mb-3"
                            />
                            <p className="text-lg font-medium text-gray-800 mb-1">{studentAddKey.name}</p>
